  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
      ...
      <div className="mb-6 p-4 bg-gray-50 rounded-lg">
        <h4 className="text-sm font-medium text-gray-900 mb-3">System Health Overview</h4>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
        {metrics.map((metric, index) => (
          <div key={index} className="border border-gray-200 rounded-lg p-4 hover:shadow-sm transition-shadow">
            ...
            <div className={`text-xs mt-2 px-2 py-1 rounded ${getStatusColor(metric.status)}`}>
      ...
      <div className="mt-6 flex flex-wrap gap-3">
        <button
          onClick={() => setMetrics(prev => prev.map(m => ({ ...m, history: m.history.map(() => m.rawValue) })))}
