...
describe('Navigation', () => {
  ...
  it('switches tabs in mobile view', async () => {
    ...
    let tabletOverviewButton = overviewButtons.find(button =>
      button.className.includes('bg-blue-100') && button.className.includes('text-blue-700') &&
    ...
    const mobileUserRolesButton = userRolesButtons.find(button =>
